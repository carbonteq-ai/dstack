...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            "user",
            "pass",
            "registry.example/org/image@sha256:" + "a" * 64,
            None,
            "registry.example/org/image@sha256:" + "a" * 64,
            RegistryAuth(username="user", password="pass"),
            id="explicit-exact-default-registry-receives-credentials",
        ),
        pytest.param(
            "registry.example:5000",
            "user",
            "pass",
            "registry.example/org/image:tag",
            None,
            "registry.example/org/image:tag",
            None,
            id="explicit-registry-port-mismatch-receives-no-credentials",
        ),
        pytest.param(
            "registry.example",
            "user",
            "pass",
            "registry.example.attacker/org/image:tag",
            None,
            "registry.example.attacker/org/image:tag",
            None,
            id="explicit-registry-suffix-mismatch-receives-no-credentials",
        ),
        pytest.param(
            "registry.example",
            "user",
            "pass",
            "attacker-registry.example/org/image:tag",
            None,
            "attacker-registry.example/org/image:tag",
            None,
            id="explicit-registry-prefix-mismatch-receives-no-credentials",
        ),
        pytest.param(
            "registry.example",
            "user",
            ...
            "registry.example/org/image:tag",
            RegistryAuth(username="run-user", password="run-pass"),
            id="explicit-exact-registry-preserves-run-auth",
        ),
        pytest.param(
            "registry.example",
            "user",
            ...
            "registry.example/org/image:tag",
            None,
            id="explicit-exact-registry-requires-complete-credentials",
        ),
        pytest.param(
            None,
            "user",
